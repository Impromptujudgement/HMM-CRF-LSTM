...
sorted_labels_chn = [
    'O', 'B-NAME', 'M-NAME', 'E-NAME', 'S-NAME', 'B-CONT', 'M-CONT', 'E-CONT',
    'S-CONT', 'B-EDU', 'M-EDU', 'E-EDU', 'S-EDU', 'B-TITLE', 'M-TITLE',
    'E-TITLE', 'S-TITLE', 'B-ORG', 'M-ORG', 'E-ORG', 'S-ORG', 'B-RACE',
    'M-RACE', 'E-RACE', 'S-RACE', 'B-PRO', 'M-PRO', 'E-PRO', 'S-PRO', 'B-LOC',
    'M-LOC', 'E-LOC', 'S-LOC'
]
...
def check(language, gold_path, my_path):
    ...
    y_true = []
    y_pred = []
    with open(gold_path, "r", encoding="gbk",
              errors="ignore") as g_f, open(my_path,
                                            "r",
                                            encoding="gbk",
                                            errors="ignore") as m_f:
        ...
        for i in range(len(g_lines)):
            ...
            y_pred.append(m_tag)
    print(
        metrics.classification_report(y_true=y_true,
                                      y_pred=y_pred,
